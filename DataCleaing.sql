-- Broke down data using Substrings, CharIndex, ParseName, and Replace
-- Use Case statements to change all the 'Y' and 'N' to 'Yes' and 'No'
-- Remove duplicates using CTE, ROWNUMBER, and Partition by
